...
public class UserDetailsService implements org.springframework.security.core.userdetails.UserDetailsService {
    ...
    /**
     * Izvlacimo korisnika iz baze po username-u za logovanje. Postoji 2 scenarija ovde
     * 1) Korisnik postoji u bazi kao i u tabeli user i sve prolazi regularno
     * 2) Korisnik postoji u bazi ali ne i u tabeli user, inicira se prvo logovanje
     * 3) Ne postoji u bazi partner, bacamo u gresku i pokazujemo na UI
     */
    @Override
