...
public class RobaGlavniService {
    ...
    private void popuniDetaljePrekoTecDoca(RobaDetaljiDto detaljiDto, Partner partner) {
        ...
        tecDocDetalji.stream()
                ...
                .forEach(mainArticlesRecord -> processMainArticle(mainArticlesRecord, partner, asociraniArtikli));
    ...
    private void processMainArticle(MainArticlesRecord mainArticlesRecord, Partner partner, List<RobaDto> asociraniArtikli) {
    ...
    private void postaviCenuIRabat(RobaDto robaDto, Partner partner) {
        robaDto.setCena(robaCeneService.vratiCenuRobePoRobiId(
                robaDto.getRobaid(), robaDto.getGrupa(), robaDto.getProizvodjac().getProid(), partner));

        robaDto.setRabat(robaCeneService.vratiRabatPartneraNaArtikal(
    ...
    private void setujDokumentaciju(RobaDetaljiDto detaljiDto, List<ArticlesByIds6Record> tecDocDetalji) {
    ...
    private static List<RobaBrojeviDto> setujOriginalneBrojeve(RobaDetaljiDto detaljiDto, List<ArticlesByIds6Record> tecDocDetalji) {
    ...
    private static void setujTehnickeDetalje(RobaDetaljiDto detaljiDto, List<ArticlesByIds6Record> tecDocDetalji) {
