...
public abstract class IzvetajMapper {
    ...
    public abstract KomentarDto map(Komentar komentar, Partner partner);

    public abstract FirmaDto map(Firma firma);
    ...
    public abstract Komentar mapIzvestaj(KreirajIzvestaj izvestaj, Firma firma, Partner partner);
    ...
    @Mapping(target = "ppid", source = "partner.ppid")
    public abstract Firma mapirajFirmu(KreirajIzvestaj izvestaj, Partner partner);

    public Timestamp map(Long time) {
