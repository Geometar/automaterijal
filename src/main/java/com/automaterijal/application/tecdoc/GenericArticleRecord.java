 ...
 *         &lt;element name="linkageTargetTypes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GenericArticleRecord {
    ...
    protected List<String> linkageTargetTypes;
    ...
    /**
     * Gets the value of the linkageTargetTypes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the linkageTargetTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLinkageTargetTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getLinkageTargetTypes() {
        if (linkageTargetTypes == null) {
            linkageTargetTypes = new ArrayList<String>();
        }
        return this.linkageTargetTypes;
    }
