 ...
 *         &lt;element name="contextSensitiveGraphics" type="{http://server.cat.tecdoc.net}ContextSensitiveGraphicsRecord" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends AssetRecord
{
    ...
    protected List<ContextSensitiveGraphicsRecord> contextSensitiveGraphics;
    ...
    /**
     * Gets the value of the contextSensitiveGraphics property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the contextSensitiveGraphics property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContextSensitiveGraphics().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ContextSensitiveGraphicsRecord }
     * 
     * 
     */
    public List<ContextSensitiveGraphicsRecord> getContextSensitiveGraphics() {
        if (contextSensitiveGraphics == null) {
            contextSensitiveGraphics = new ArrayList<ContextSensitiveGraphicsRecord>();
        }
        return this.contextSensitiveGraphics;
    }
